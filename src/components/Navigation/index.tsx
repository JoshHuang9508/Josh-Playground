...
export default function Navigation({ currentHash }: NavigationProps) {
  const { setIsSettingsOpen, isSettingsOpen } = useContext(AppContext)!;
  ...
  return (
    <nav className={styles['breadcrumb']}>
      ...
      <button type="button" className={styles['gear']} aria-label="Open settings" title="Settings" onClick={() => setIsSettingsOpen(!isSettingsOpen)}>
