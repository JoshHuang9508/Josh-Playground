    ...
    commands: {
      ...
      theme: {
        ...
        color: {
          ...
          set: 'Theme color set: @#fff700hsl({0})@#',
        ...
        accent: {
          add: {
            ...
            usage: '@#00ffaatheme accent add@# @#fff700<#hex>@#',
